...
pangodraw() {
	date +"%-I:%M %P" #date with some pango markup syntax (https://docs.gtk.org/Pango/pango_markup.html)
	date +"<small><small><small><small>%A</small></small></small></small>"
	date +"<small><small><small><small>%B %d, %Y</small></small></small></small>"
